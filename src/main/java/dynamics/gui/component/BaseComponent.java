...
import dynamics.gui.listener.IKeyTypedListener;
import dynamics.gui.listener.IMouseDownListener;
import dynamics.gui.listener.IMouseDragListener;
import dynamics.gui.listener.IMouseUpListener;
import dynamics.utils.TextureUtils;
...
public abstract class BaseComponent extends Gui {
    ...
    public final static ResourceLocation TEXTURE_SHEET = new ResourceLocation("dynamiclib", "textures/gui/components.png");
